...
*
* $Id: DBIN.java,v 1.1 2004/11/22 18:27:57 kate Exp $
*/
...
public final class DBIN extends BIN implements LoggableObject {
    ...
    /* 
     * A DBIN can be the ancestor of a LN.
     */
    ...
    /*
     * A DBIN's children are always evictable because they are only LNs.
     */
	...
	throws DatabaseException {
	    ...
	    if (ref != null) {
		LN ln = (LN) ref.fetchTarget(getDatabase(), this);
		if (ln != null) {
