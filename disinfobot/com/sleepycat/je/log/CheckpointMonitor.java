...
*
* $Id: CheckpointMonitor.java,v 1.1 2004/11/22 18:27:58 kate Exp $
*/
...
/**
 * The checkpoint monitor saves information about log writes to decide
...
class CheckpointMonitor {
    ...
    CheckpointMonitor(EnvironmentImpl envImpl)
        ...
        /*
         * The period is reset each activation and is not synchronized with
         * the interval counted by the Checkpointer.  Use a small enough
         * period to invoke the Checkpointer within 10% of its interval.
         */
        periodInBytes /= 10;
    ...
    /**
     * Update checkpoint driving information. Call from within the
     * log write latch.
