...
*
* $Id: SyncedLogManager.java,v 1.1 2004/11/22 18:27:58 kate Exp $
*/
...
/**
 * The SyncedLogManager uses the synchronized keyword to 
 * implement protected regions.
 */
public class SyncedLogManager extends LogManager {
    ...
    public void countObsoleteLNs(DbLsn lsn1, boolean obsolete1,
        ...
        synchronized (logWriteLatch) {
            countObsoleteLNsInternal(tracker,
                                     lsn1, obsolete1, lsn2, obsolete2);
        }
    }
