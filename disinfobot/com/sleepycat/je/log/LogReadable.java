...
*
* $Id: LogReadable.java,v 1.1 2004/11/22 18:27:58 kate Exp $
*/
...
/**
 * A class that implements LogReadable knows how to read itself from
 * the JE log.
 */
public interface LogReadable {
    ...
    /**
     * Write the object into the string buffer
     * for log dumping. Each object should be dumped without
