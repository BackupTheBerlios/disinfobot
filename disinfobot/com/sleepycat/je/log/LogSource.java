...
*
* $Id: LogSource.java,v 1.1 2004/11/22 18:27:58 kate Exp $
*/
...
interface LogSource {
    ...
    /** 
     * Fill the destination byte array with bytes. The offset indicates
     * the absolute log file position.
     */
    ByteBuffer getBytes(long fileOffset) throws IOException;

    /** 
     * Fill the destination byte array with the requested number of bytes.
     * The offset indicates the absolute position in the log file.
     */
