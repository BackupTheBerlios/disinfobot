...
*
* $Id: Tracer.java,v 1.1 2004/11/22 18:27:58 kate Exp $
*/
 ...
 * facility. There are three log handlers set up for logging -- 
 * the database log itself, an output file, and stdout (the "console").
 * By default, only the database file is enabled.
 */
public class Tracer implements LoggableObject, LogReadable {

    /* 
     * Name pattern for tracing output that's been directed into a 
     * log file by enabling the file handler.
     */
    ...
    /**
     * Log trace iformation about root deletions, called by INCompressor
     * and recovery.
     */
    ...
    public boolean equals(Object obj) {
        ...
        // We could compare all the fields individually, but since
        // they're all placed in our toString() method, we can just
        // compare the String version of each offer.
